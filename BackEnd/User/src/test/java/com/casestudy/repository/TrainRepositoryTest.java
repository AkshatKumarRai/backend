...
class TrainRepositoryTest {
    ...
    train1= new TrainModel("15043","LKO Exp","Lucknow","Gorakhpur",1345,110,"21:23"); //user input
    train2= new TrainModel("16043","VNS Exp","Varansi","Gorakhpur",1845,130,"13:46");  //user input 
	...
	public void updateTrainDetailById(){
	     ...
	     String name2="VNS Exp";
	     train1= new TrainModel("17078","VNS Exp","Varansi","Gorakhpur",1945,170,"05:00"); //user input
	     repository.save(train1);
